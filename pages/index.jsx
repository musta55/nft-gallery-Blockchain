...
const api_key = "mF-eXSx-BVMMyLePAixpaFf9Xf_rPuDu";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 gap-y-3">
      ...
      <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">NFT <span class="text-blue-600 dark:text-blue-500">Gallery</span></h1>
        ...
        <button className={"disabled:bg-slate-500 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"} onClick={
          () => {
